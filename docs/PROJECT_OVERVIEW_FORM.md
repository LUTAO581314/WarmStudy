...
Assistive education with emphasis on “助育” and adolescent psychological support

## 4. Project Background

Adolescent mental health issues have become increasingly prominent in school and family settings. Students often lack low-threshold emotional expression channels, parents have difficulty identifying emotional trends in time, and schools need more efficient tools for early support and light intervention.

## 5. Core Problem To Solve

1. students lack a convenient and continuous emotional expression channel
2. parents cannot easily understand long-term emotional trends
3. schools lack lightweight digital tools for psychological support and early discovery
...
4. psychological knowledge retrieval based on RAG
...
- model access: Qwen / DashScope API
